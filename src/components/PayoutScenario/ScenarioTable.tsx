      ...
      <table className="w-full min-w-max border-collapse">
        <thead>
          <tr className="border-b border-white/25">
            <th className="px-2 pb-3 text-sm font-bold text-white">수령방식</th>
            <th className="px-2 pb-3 text-sm font-bold text-white">월 수령액 (예상)</th>
            <th className="px-2 pb-3 text-sm font-bold text-white">총 수령액 (만원)</th>
            <th className="px-2 pb-3 text-sm font-bold text-white">자산 고갈 예상 나이</th>
            <th className="px-2 pb-3 text-sm font-bold text-white">손익분기 나이</th>
          </tr>
        </thead>
        ...
        <tbody>
          {scenarios.map((scenario) => (
            <tr key={scenario.method} className="border-b border-white/15">
              ...
              <td className="px-2 py-4 text-center text-sm whitespace-pre-line text-white">
              ...
              <td className="px-2 py-4 text-center text-sm whitespace-nowrap text-white">
